...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      // ── 프리미엄 다크 시네마틱 스킨 (게임 패널은 페이지 테마와 무관하게 어두운 "게임 화면") ──
      '.nmg-wrap{position:relative;overflow:hidden;border:1px solid rgba(148,163,184,.16);border-radius:20px;padding:18px;background:radial-gradient(900px 260px at 15% -8%,rgba(251,191,36,.08),transparent 55%),radial-gradient(700px 300px at 90% 0%,rgba(99,102,241,.10),transparent 55%),linear-gradient(165deg,#10182b 0%,#0a0f1d 58%,#0d1226 100%);box-shadow:0 24px 70px rgba(2,6,23,.55),inset 0 1px 0 rgba(255,255,255,.05);margin:10px 0;font-family:"Noto Sans KR",sans-serif;color:#e2e8f0}',
      '.nmg-board{display:flex;align-items:center;gap:12px;margin-bottom:10px}',
      '.nmg-score{font-weight:900;font-size:16px;color:#fbbf24;text-shadow:0 0 14px rgba(251,191,36,.35);letter-spacing:.02em}',
      '.nmg-combo{font-weight:900;font-size:13px;color:#fb923c;min-width:62px;text-shadow:0 0 10px rgba(251,146,60,.4)}',
      '.nmg-prog{flex:1;height:8px;border-radius:99px;background:rgba(148,163,184,.14);overflow:hidden;box-shadow:inset 0 1px 2px rgba(0,0,0,.4)}',
      '.nmg-prog-fill{position:relative;height:100%;width:0;border-radius:99px;background:linear-gradient(90deg,#b45309,#f59e0b,#fbbf24,#fde047);box-shadow:0 0 12px rgba(251,191,36,.45);transition:width .35s ease;overflow:hidden}',
      '.nmg-prog-fill:after{content:"";position:absolute;inset:0;background:linear-gradient(105deg,transparent 30%,rgba(255,255,255,.55) 50%,transparent 70%);background-size:200% 100%;animation:nmg-sheen 2.2s linear infinite}',
      '.nmg-wrap .nmg-mute{border:1px solid rgba(148,163,184,.22)!important;border-radius:9px;background:rgba(15,23,42,.6)!important;color:#cbd5e1!important;font-size:15px;padding:3px 8px;cursor:pointer;line-height:1}',
      '.nmg-prompt{margin:2px 0 12px;font-weight:800;font-size:15px;color:#f1f5f9;letter-spacing:-.01em}',
      '.nmg-canvas{width:100%;height:190px;border:1px solid rgba(148,163,184,.14);border-radius:14px;overflow:hidden;background:radial-gradient(circle at 50% 38%,rgba(99,102,241,.14),transparent 46%),linear-gradient(180deg,#0a0f1e,#0d1428);box-shadow:inset 0 0 46px rgba(2,6,23,.75),inset 0 0 120px rgba(99,102,241,.06)}',
      '.nmg-status{min-height:22px;margin:10px 0;font-size:13.5px;font-weight:600;color:#94a3b8}',
      '.nmg-status.done{color:#4ade80}.nmg-status.bad{color:#f87171}',
      ...
      '.nmg-kicker{font-weight:900;font-size:11.5px;letter-spacing:.14em;color:#fbbf24;text-transform:uppercase;text-shadow:0 0 10px rgba(251,191,36,.3)}',
      '.nmg-wrap .nmg-hint{border:1px solid rgba(251,191,36,.35)!important;border-radius:999px;background:rgba(251,191,36,.10)!important;color:#fcd34d!important;padding:6px 12px;font-size:12px;font-weight:800;cursor:pointer}',
      '.nmg-trail{display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:8px;width:100%}',
      '.nmg-wrap .nmg-trail-slot{position:relative;min-height:88px;border:1px solid rgba(148,163,184,.18)!important;border-radius:13px;background:rgba(148,163,184,.06)!important;padding:10px;text-align:left;display:flex;flex-direction:column;gap:5px;color:#e2e8f0!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}',
      '.nmg-wrap .nmg-trail-slot.active{border:2px dashed rgba(251,191,36,.65)!important;background:rgba(251,191,36,.07)!important;box-shadow:0 0 0 4px rgba(251,191,36,.08),0 8px 24px rgba(251,191,36,.14);cursor:pointer;animation:nmg-pulse 1.7s ease-in-out infinite}',
      '.nmg-wrap .nmg-trail-slot.over,.nmg-wrap .nmg-slot.over{transform:translateY(-3px) scale(1.015);border-color:#34d399!important;background:rgba(16,185,129,.10)!important;box-shadow:0 10px 25px rgba(16,185,129,.22)}',
      '.nmg-wrap .nmg-trail-slot.done{border-color:rgba(52,211,153,.45)!important;background:rgba(16,185,129,.08)!important}',
      '.nmg-wrap .nmg-trail-slot.bad{border-color:#f87171!important;background:rgba(239,68,68,.10)!important;animation:nmg-shake .4s}',
      '.nmg-stepno{width:24px;height:24px;border-radius:50%;display:grid;place-items:center;background:rgba(251,191,36,.14);color:#fcd34d;font-weight:900;font-size:12px;border:1px solid rgba(251,191,36,.3)}',
      '.nmg-trail-slot.done .nmg-stepno{background:#059669;color:#fff;border-color:transparent}',
      '.nmg-stepname{font-size:12px;font-weight:900;line-height:1.35;color:#f1f5f9}.nmg-stepwhy{font-size:11px;color:#94a3b8;line-height:1.38}',
      '.nmg-stepempty{font-size:12px;font-weight:800;color:#fcd34d;margin:auto 0}.nmg-trail-slot:disabled .nmg-stepempty{color:#64748b}',
      '.nmg-deck-label{font-size:11px;font-weight:800;color:#94a3b8;letter-spacing:.06em}',
      '.nmg-deck{display:flex;flex-wrap:wrap;gap:9px;padding:12px;border:1px solid rgba(148,163,184,.14);border-radius:14px;background:rgba(2,6,23,.35);min-height:54px}',
      '.nmg-slot-row{display:flex;flex-wrap:wrap;gap:10px;width:100%}',
      '.nmg-wrap .nmg-slot{flex:1;min-width:140px;min-height:84px;border:2px dashed rgba(148,163,184,.28)!important;border-radius:13px;background:rgba(148,163,184,.05)!important;color:#e2e8f0!important;padding:11px;cursor:pointer;display:flex;flex-direction:column;gap:7px;align-items:flex-start;text-align:left;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}',
      '.nmg-wrap .nmg-slot:hover{border-color:rgba(251,191,36,.55)!important}.nmg-slot.empty .nmg-slot-val{color:#64748b;font-weight:600}',
      '.nmg-wrap .nmg-slot.ok{border-style:solid!important;border-color:#34d399!important;background:rgba(16,185,129,.12)!important;cursor:default;box-shadow:0 7px 18px rgba(16,185,129,.18)}',
      '.nmg-wrap .nmg-slot.bad{border-color:#f87171!important;background:rgba(239,68,68,.10)!important;animation:nmg-shake .4s}',
      '.nmg-slot-label{font-weight:800;font-size:12px;color:#94a3b8}',
      '.nmg-slot-val{font-weight:800;font-size:14px;color:#f1f5f9}',
      '.nmg-hearts{font-size:13px;font-weight:900;color:#fb7185;letter-spacing:.06em;text-shadow:0 0 10px rgba(251,113,133,.35)}',
      '.nmg-situation{box-sizing:border-box;width:100%;font-weight:800;font-size:15px;line-height:1.55;color:#f8fafc;background:linear-gradient(135deg,rgba(251,191,36,.10),rgba(99,102,241,.10));border:1px solid rgba(251,191,36,.22);border-left:3px solid #f59e0b;border-radius:14px;padding:15px 16px;box-shadow:0 10px 26px rgba(2,6,23,.45)}',
      '.nmg-timer{width:100%;height:6px;border-radius:99px;background:rgba(148,163,184,.14);overflow:hidden;box-shadow:inset 0 1px 2px rgba(0,0,0,.4)}.nmg-timer-fill{width:100%;height:100%;border-radius:inherit;background:linear-gradient(90deg,#059669,#34d399,#a3e635);box-shadow:0 0 10px rgba(52,211,153,.5);transition:width .24s linear}.nmg-timer.danger .nmg-timer-fill{background:linear-gradient(90deg,#dc2626,#f59e0b);box-shadow:0 0 10px rgba(239,68,68,.55)}',
      '.nmg-choice-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;width:100%}',
      '.nmg-choice{position:relative;min-height:58px;border-radius:13px!important;padding:11px 13px 11px 46px!important;display:flex;align-items:center;background:rgba(148,163,184,.07);box-shadow:0 6px 16px rgba(2,6,23,.35)}',
      '.nmg-choice.muted{opacity:.42}.nmg-key{position:absolute;left:11px;width:24px;height:24px;border-radius:8px;display:grid;place-items:center;background:rgba(251,191,36,.13);border:1px solid rgba(251,191,36,.3);color:#fcd34d;font-size:11px;font-weight:900}',
      '.nmg-reveal{width:100%;box-sizing:border-box;border:1px solid rgba(52,211,153,.4);border-radius:13px;background:rgba(16,185,129,.12);color:#6ee7b7;padding:11px 13px;font-size:13px;font-weight:800;line-height:1.45;animation:nmg-pop .28s ease}',
      ...
      '.nmg-bucket{flex:1;min-width:120px;min-height:74px;border:2px dashed rgba(148,163,184,.28);border-radius:12px;background:rgba(148,163,184,.05);padding:8px;cursor:pointer;display:flex;flex-direction:column;gap:6px;align-items:center;color:#e2e8f0}',
      '.nmg-bucket:hover{border-color:rgba(251,191,36,.55)}.nmg-bucket.bad{border-color:#f87171;animation:nmg-shake .4s}',
      '.nmg-bk-name{font-weight:800;font-size:13px;color:#f1f5f9}',
      '.nmg-placed{font-size:12px;font-weight:700;color:#6ee7b7;background:rgba(16,185,129,.15);border:1px solid rgba(52,211,153,.35);border-radius:999px;padding:3px 9px}',
      '.nmg-wrap .nmg-chip{padding:9px 15px;border:1px solid rgba(148,163,184,.20)!important;border-radius:999px;background:rgba(148,163,184,.07)!important;color:#e2e8f0!important;font-weight:700;font-size:14px;cursor:pointer;transition:transform .12s ease,background .12s ease,border-color .12s ease,opacity .12s ease,box-shadow .12s ease;text-align:left}',
      // 카드는 알약이 아니라 둥근 사각형(끌어 놓는 슬롯과 같은 계열)이다. 위 .nmg-wrap .nmg-chip과 특이도를 맞춰야 radius·cursor가 실제로 먹는다.
      '.nmg-wrap .nmg-card{border-radius:11px;box-shadow:0 4px 12px rgba(2,6,23,.4);cursor:grab;user-select:none}.nmg-card:active{cursor:grabbing}.nmg-card.dragging{opacity:.45;transform:scale(.96)}',
      '.nmg-core:before{content:"◆";color:#fbbf24;margin-right:7px;text-shadow:0 0 8px rgba(251,191,36,.5)}',
      ...
      '.nmg-wrap .nmg-chip:hover{border-color:rgba(251,191,36,.55)!important;background:rgba(251,191,36,.09)!important;transform:translateY(-1px);box-shadow:0 6px 16px rgba(251,191,36,.12)}.nmg-chip:focus-visible{outline:2px solid #fbbf24;outline-offset:2px}',
      '.nmg-wrap .nmg-chip.sel{border-color:#fbbf24!important;background:rgba(251,191,36,.13)!important;box-shadow:0 0 0 3px rgba(251,191,36,.12),0 6px 18px rgba(251,191,36,.16)}',
      '.nmg-wrap .nmg-chip.ok{background:rgba(16,185,129,.14)!important;border-color:#34d399!important;color:#6ee7b7!important;cursor:default;box-shadow:0 0 14px rgba(16,185,129,.18)}',
      '.nmg-wrap .nmg-chip.bad{background:rgba(239,68,68,.12)!important;border-color:#f87171!important;color:#fca5a5!important;animation:nmg-shake .4s}',
      '.nmg-pop{animation:nmg-pop .28s ease}',
      '.nmg-wrap .nmg-reset{margin-top:14px;padding:8px 15px;border:1px solid rgba(148,163,184,.22)!important;border-radius:9px;background:transparent!important;color:#94a3b8!important;font-weight:700;font-size:13px;cursor:pointer}',
      '.nmg-wrap .nmg-reset:hover{border-color:rgba(251,191,36,.5)!important;color:#fcd34d!important}',
      '.nmg-float{position:absolute;transform:translate(-50%,-50%);font-weight:900;font-size:17px;pointer-events:none;animation:nmg-rise .9s ease-out forwards;z-index:5;text-shadow:0 0 12px rgba(251,191,36,.6),0 2px 6px rgba(0,0,0,.6)}',
      '.nmg-spark{position:absolute;width:7px;height:7px;border-radius:50%;pointer-events:none;animation:nmg-spk .55s ease-out forwards;z-index:5;box-shadow:0 0 8px rgba(251,191,36,.7)}',
      ...
      '.nmg-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(2,6,23,.78);backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);z-index:8;animation:nmg-fade .3s ease}',
      '.nmg-ovcard{background:linear-gradient(165deg,#141c31,#0b1120);border:1px solid rgba(251,191,36,.30);border-radius:18px;padding:26px 34px;text-align:center;box-shadow:0 24px 70px rgba(0,0,0,.6),0 0 40px rgba(251,191,36,.10),inset 0 1px 0 rgba(255,255,255,.06)}',
      '.nmg-stars{font-size:40px;color:#fbbf24;letter-spacing:6px;text-shadow:0 0 18px rgba(251,191,36,.65),0 0 46px rgba(251,191,36,.30);animation:nmg-starpop .5s cubic-bezier(.2,1.6,.4,1)}',
      '.nmg-ovscore{margin:10px 0 16px;font-weight:900;font-size:16px;color:#f1f5f9}',
      '.nmg-best{color:#4ade80;text-shadow:0 0 10px rgba(74,222,128,.4)}.nmg-bestq{color:#94a3b8;font-weight:600;font-size:13px}',
      '.nmg-wrap .nmg-again{padding:11px 24px;border:none!important;border-radius:11px;background:linear-gradient(135deg,#f59e0b,#fbbf24)!important;color:#1c1005!important;font-weight:900;font-size:15px;cursor:pointer;box-shadow:0 8px 22px rgba(245,158,11,.35),inset 0 1px 0 rgba(255,255,255,.35);transition:transform .12s ease,box-shadow .12s ease}',
      '.nmg-wrap .nmg-again:hover{transform:translateY(-1px);box-shadow:0 12px 28px rgba(245,158,11,.45),inset 0 1px 0 rgba(255,255,255,.35)}',
      ...
      '@keyframes nmg-pulse{0%,100%{box-shadow:0 0 0 3px rgba(251,191,36,.08),0 8px 24px rgba(251,191,36,.12)}50%{box-shadow:0 0 0 7px rgba(251,191,36,.18),0 10px 28px rgba(251,191,36,.22)}}',
      ...
      '@keyframes nmg-sheen{0%{background-position:200% 0}100%{background-position:-200% 0}}',
      '@keyframes nmg-starpop{0%{transform:scale(.4);opacity:0}70%{transform:scale(1.12)}100%{transform:scale(1);opacity:1}}',
      ...
      '@media (prefers-reduced-motion:reduce){.nmg-wrap .nmg-chip,.nmg-wrap .nmg-chip.bad,.nmg-bucket.bad,.nmg-pop,.nmg-float,.nmg-reveal,.nmg-wrap .nmg-trail-slot,.nmg-wrap .nmg-trail-slot.active,.nmg-wrap .nmg-trail-slot.bad,.nmg-wrap .nmg-slot,.nmg-wrap .nmg-slot.bad,.nmg-prog-fill:after,.nmg-stars{animation:none;transition:none}}'
    ].join('');
