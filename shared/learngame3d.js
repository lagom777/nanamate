...
(function () {
  ...
  function pathViz(ctx, N) {
    ...
    return {
      fill: function (i, t) { if (!base) return; slots[i].m.material.color.setHex(ctx.colorHex); var sp = labelSprite(t, ctx.color); sp.position.set(slots[i].x, 0.85, 0); base.scene.add(sp); labels.push(sp); },
